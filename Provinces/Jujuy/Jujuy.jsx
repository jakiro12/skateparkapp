    ...
    return(
        ...
        <View style={ViewContainer.values}>         
           ...
           <View style={CardInfo.values}>
            <Text> San Salvador de Jujuy</Text>
            <Text> ubixx</Text> 
            <TouchableOpacity style={TextUbication.btn} onPress={()=>OpenMap(BikeParksData.san_salvador_de_jujuy)}><Text > Ubicacion</Text></TouchableOpacity>
            </View>  
             </Text>
       ...
       style={{width: 50, height: 50,position:'absolute',top:'15%',right:'10%'}} />  
           ...
           <View style={CardInfo.values}>
            <Text> Palpala</Text>
            <Text> ubixx</Text> 
            <TouchableOpacity style={TextUbication.btn} onPress={()=>OpenMap(BikeParksData.palpala)}><Text > Ubicacion</Text></TouchableOpacity>
            </View>  
             </Text>
             <Image source={{uri: 'https://reactjs.org/logo-og.png'}}
       style={{width: 50, height: 50,position:'absolute',top:'15%',right:'10%'}} />  
