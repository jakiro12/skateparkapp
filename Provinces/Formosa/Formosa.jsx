    ...
    return(
        ...
        <View style={ViewContainer.values}>         
           ...
           <View style={CardInfo.values}>
            <Text style={FontAdd.values}> Formosa capital</Text>
            <Text style={FontAdd.values}> Plaza San Martin</Text> 
            <TouchableOpacity style={TextUbication.btn} onPress={()=>OpenMap(BikeParksData.formosa_plaza)}><Text style={FontAdd.values}> Ubicacion</Text></TouchableOpacity>
            </View>  
             </Text>
             <Modal            
              animationType='none'
       ...
       style={{height:80,width:80,}} /> </Text></TouchableOpacity>  
            ...
            <View style={ViewBox.card}>
                ...
                <View style={CardInfo.values}>
                    ...
                    <TouchableOpacity style={TextUbication.btn} onPress={()=>OpenMap(BikeParksData.formosa_ciudad)}><Text style={FontAdd.values}> Ubicacion</Text></TouchableOpacity>
            </View>  
             </Text>
             <Modal            
              animationType='none'
