    ...
    return(
        ...
        <View style={ViewContainer.values}>         
           ...
           <View style={CardInfo.values}>
            <Text> San Miguel de Tucuman</Text>
            <Text> Av. Mate de Luna 4000</Text> 
            <TouchableOpacity style={TextUbication.btn} onPress={()=>OpenMap(BikeParksData.san_miguel_de_tucuman)}><Text > Ubicacion</Text></TouchableOpacity>
            </View>  
             </Text>
